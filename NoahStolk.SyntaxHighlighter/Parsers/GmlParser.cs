...
{
	private static readonly Lazy<GmlParser> _lazy = new(() => new GmlParser());
	...
	public override string Name => "GML";

	public override Language CodeLanguage { get; } = new(
		reservedKeywords: new Dictionary<string, string[]>
		{
			["KeywordDefault"] = ["self", "other", "all", "noone", "var", "enum", "global", "globalvar"],
			["KeywordConditional"] = ["break", "case", "continue", "do", "else", "exit", "for", "if", "repeat", "return", "switch", "while", "with"],
			["KeywordLocal"] = ["alarm", "bbox_bottom", "bbox_left", "bbox_right", "bbox_top", "depth", "direction", "friction", "gravity", "gravity_direction", "hspeed", "id", "image_alpha", "image_angle", "image_blend", "image_index", "image_number", "image_single", "image_speed", "image_xscale", "image_yscale", "mask_index", "object_index", "path_endaction", "path_index", "path_orientation", "path_position", "path_positionprevious", "path_scale", "path_speed", "persistent", "solid", "speed", "sprite_height", "sprite_index", "sprite_width", "sprite_xoffset", "sprite_yoffset", "timeline_index", "timeline_position", "timeline_speed", "visible", "vspeed", "x", "xprevious", "xstart", "y", "yprevious", "ystart"],
