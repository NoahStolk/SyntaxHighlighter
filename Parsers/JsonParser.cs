...
namespace SyntaxHighlighter.Parsers
{
	public sealed class JsonParser : AbstractParser
	{
		...
		public static JsonParser Instance => lazy.Value;
		...
		protected override Piece HandleLanguageSpecificCodeTypes(string[] pieces, int index) => new Piece(pieces[index], "Other");
	}
}